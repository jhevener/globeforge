...
class DirAccess(py4godot_refcounted.RefCounted):
  ...
  def open(path:'str'   ) -> typing.Union['typing.Self']:
    ...
    _ret._ptr = static_method(1021,0,tuple([py_string_path._ptr]))
  ...
  def get_open_error() -> typing.Union[int]:
    ...
    _ret:int
    _ret = static_method(1021,1,tuple([]))
    return _ret
  ...
  def create_temp(prefix:'str' =""  , keep:'bool' =False  ) -> typing.Union['typing.Self']:
    ...
    _ret = DirAccess.construct_without_init()
    _ret._ptr = static_method(1021,2,tuple([py_string_prefix._ptr, keep]))
    return smart_cast(_ret) if not _ret._ptr.is_null() else None
  ...
  def get_files_at(path:'str'   ) -> typing.Union['PackedStringArray']:
    ...
    _ret = PackedStringArray.construct_without_init()
    _ret._ptr = static_method(1021,3,tuple([py_string_path._ptr]))
    return _ret
  ...
  def get_directories_at(path:'str'   ) -> typing.Union['PackedStringArray']:
    ...
    _ret = PackedStringArray.construct_without_init()
    _ret._ptr = static_method(1021,4,tuple([py_string_path._ptr]))
    return _ret
  ...
  def get_drive_count() -> typing.Union[int]:
    ...
    _ret = 0
    _ret = static_method(1021,5,tuple([]))
    return _ret
  ...
  def get_drive_name(idx:'int'   ) -> typing.Union[str]:
    ...
    _ret = String.construct_without_init()
    _ret._ptr = static_method(1021,6,tuple([idx]))
    return utils.gd_string_to_py_string(_ret)
  ...
  def make_dir_absolute(path:'str'   ) -> typing.Union[int]:
    ...
    _ret:int
    _ret = static_method(1021,7,tuple([py_string_path._ptr]))
    return _ret
  ...
  def make_dir_recursive_absolute(path:'str'   ) -> typing.Union[int]:
    ...
    _ret:int
    _ret = static_method(1021,8,tuple([py_string_path._ptr]))
    return _ret
  ...
  def dir_exists_absolute(path:'str'   ) -> typing.Union[bool]:
    ...
    _ret = 0
    _ret = static_method(1021,9,tuple([py_string_path._ptr]))
    return _ret
  ...
  def copy_absolute(from_:'str'   , to:'str'   , chmod_flags:'int' =-1  ) -> typing.Union[int]:
    ...
    _ret:int
    _ret = static_method(1021,10,tuple([py_string_from_._ptr, py_string_to._ptr, chmod_flags]))
    return _ret
  ...
  def rename_absolute(from_:'str'   , to:'str'   ) -> typing.Union[int]:
    ...
    _ret:int
    _ret = static_method(1021,11,tuple([py_string_from_._ptr, py_string_to._ptr]))
    return _ret
  ...
  def remove_absolute(path:'str'   ) -> typing.Union[int]:
    ...
    _ret:int
    _ret = static_method(1021,12,tuple([py_string_path._ptr]))
    return _ret
