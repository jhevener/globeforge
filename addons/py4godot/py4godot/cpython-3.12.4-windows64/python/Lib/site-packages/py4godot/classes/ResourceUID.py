...
class ResourceUID(py4godot_object.Object):
  ...
  def instance():
    ...
    if _ResourceUID_singleton_instance is None:
      ...
      singleton._ptr = constructor(999,0, ())
  ...
  def uid_to_path(uid:'str'   ) -> typing.Union[str]:
    ...
    _ret = String.construct_without_init()
    _ret._ptr = static_method(999,0,tuple([py_string_uid._ptr]))
    return utils.gd_string_to_py_string(_ret)
  ...
  def path_to_uid(path:'str'   ) -> typing.Union[str]:
    ...
    _ret = String.construct_without_init()
    _ret._ptr = static_method(999,1,tuple([py_string_path._ptr]))
    return utils.gd_string_to_py_string(_ret)
  ...
  def ensure_path(path_or_uid:'str'   ) -> typing.Union[str]:
    ...
    _ret = String.construct_without_init()
    _ret._ptr = static_method(999,2,tuple([py_string_path_or_uid._ptr]))
    return utils.gd_string_to_py_string(_ret)
