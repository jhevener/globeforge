...
class Node(py4godot_object.Object):
  ...
  @property
  def multiplayer(self) -> typing.Union['py4godot_scenemultiplayer.SceneMultiplayer','py4godot_multiplayerapi.MultiplayerAPI','py4godot_multiplayerapiextension.MultiplayerAPIExtension']:
    r''''''
  ...
  @functools.native_method
  def get_multiplayer(self) -> typing.Union['py4godot_scenemultiplayer.SceneMultiplayer','py4godot_multiplayerapi.MultiplayerAPI','py4godot_multiplayerapiextension.MultiplayerAPIExtension']:
    r''''''
