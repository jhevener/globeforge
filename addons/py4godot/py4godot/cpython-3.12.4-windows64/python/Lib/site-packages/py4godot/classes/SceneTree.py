...
class SceneTree(py4godot_mainloop.MainLoop):
  ...
  @functools.native_method
  def get_multiplayer(self, for_path:'object' = None  ) -> typing.Union['py4godot_scenemultiplayer.SceneMultiplayer','py4godot_multiplayerapi.MultiplayerAPI','py4godot_multiplayerapiextension.MultiplayerAPIExtension']:
    r'''
