...
class MultiplayerAPI(py4godot_refcounted.RefCounted):
  ...
  @staticmethod
  def create_default_interface() -> typing.Union['py4godot_scenemultiplayer.SceneMultiplayer','typing.Self','py4godot_multiplayerapiextension.MultiplayerAPIExtension']:
    r'''
