...
class FontVariation(py4godot_font.Font):
  ...
  @property
  def base_font(self) -> typing.Union['py4godot_fontfile.FontFile','py4godot_systemfont.SystemFont','typing.Self','py4godot_font.Font']:
    r''''''
  ...
  @functools.native_method
  def get_base_font(self) -> typing.Union['py4godot_fontfile.FontFile','py4godot_systemfont.SystemFont','typing.Self','py4godot_font.Font']:
    r''''''
