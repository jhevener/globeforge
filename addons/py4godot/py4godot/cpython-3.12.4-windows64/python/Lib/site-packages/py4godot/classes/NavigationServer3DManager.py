...
from py4godot.wrappers.wrappers import CPPNavigationServer3DManagerWrapper

_NavigationServer3DManager_singleton_instance = None

class NavigationServer3DManager(py4godot_object.Object):
  r'''
  ...
  def generate_wrapper(self):
    return CPPNavigationServer3DManagerWrapper()
  def init_signals(self):
    super().init_signals()

  @staticmethod
  def construct_without_init():
    cls = NavigationServer3DManager.__new__(NavigationServer3DManager)
  ...
  def cast(other:'Object'):
    ...
    cls = NavigationServer3DManager.construct_without_init()
    cls._ptr = CPPNavigationServer3DManagerWrapper()
  ...
  @staticmethod
  def instance():
    global _NavigationServer3DManager_singleton_instance
    if _NavigationServer3DManager_singleton_instance is None:
      singleton = NavigationServer3DManager()
      singleton._ptr = constructor(857,0, ())
      _NavigationServer3DManager_singleton_instance = singleton
    return _NavigationServer3DManager_singleton_instance
...
register_cast_function('NavigationServer3DManager', NavigationServer3DManager.cast)
register_class('NavigationServer3DManager', NavigationServer3DManager)
