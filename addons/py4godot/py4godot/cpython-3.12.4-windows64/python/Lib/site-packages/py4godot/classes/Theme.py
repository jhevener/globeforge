...
class Theme(py4godot_resource.Resource):
  ...
  @property
  def default_font(self) -> typing.Union['py4godot_fontfile.FontFile','py4godot_systemfont.SystemFont','py4godot_fontvariation.FontVariation','py4godot_font.Font']:
    r''''''
  ...
  @functools.native_method
  def get_stylebox(self, name:'object'   , theme_type:'object'   ) -> typing.Union['py4godot_styleboxflat.StyleBoxFlat','py4godot_styleboxtexture.StyleBoxTexture','py4godot_styleboxline.StyleBoxLine','py4godot_stylebox.StyleBox','py4godot_styleboxempty.StyleBoxEmpty']:
    r'''
  ...
  @functools.native_method
  def get_font(self, name:'object'   , theme_type:'object'   ) -> typing.Union['py4godot_fontfile.FontFile','py4godot_systemfont.SystemFont','py4godot_fontvariation.FontVariation','py4godot_font.Font']:
    r'''
  ...
  @functools.native_method
  def get_default_font(self) -> typing.Union['py4godot_fontfile.FontFile','py4godot_systemfont.SystemFont','py4godot_fontvariation.FontVariation','py4godot_font.Font']:
    r''''''
