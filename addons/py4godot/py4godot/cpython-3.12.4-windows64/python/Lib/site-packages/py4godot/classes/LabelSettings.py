...
class LabelSettings(py4godot_resource.Resource):
  ...
  @property
  def font(self) -> typing.Union['py4godot_fontfile.FontFile','py4godot_systemfont.SystemFont','py4godot_fontvariation.FontVariation','py4godot_font.Font']:
    r''''''
    _ret = self. get_font()
    return _ret
  @font.setter
  ...
  @functools.native_method
  def get_font(self) -> typing.Union['py4godot_fontfile.FontFile','py4godot_systemfont.SystemFont','py4godot_fontvariation.FontVariation','py4godot_font.Font']:
    r''''''
