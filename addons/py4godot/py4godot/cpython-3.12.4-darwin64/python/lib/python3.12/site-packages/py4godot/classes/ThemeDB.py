...
class ThemeDB(py4godot_object.Object):
  ...
  @property
  def fallback_font(self) -> typing.Union['py4godot_fontfile.FontFile','py4godot_systemfont.SystemFont','py4godot_fontvariation.FontVariation','py4godot_font.Font']:
    r''''''
  ...
  @property
  def fallback_stylebox(self) -> typing.Union['py4godot_styleboxflat.StyleBoxFlat','py4godot_styleboxtexture.StyleBoxTexture','py4godot_styleboxline.StyleBoxLine','py4godot_stylebox.StyleBox','py4godot_styleboxempty.StyleBoxEmpty']:
    r''''''
  ...
  @functools.native_method
  def get_fallback_font(self) -> typing.Union['py4godot_fontfile.FontFile','py4godot_systemfont.SystemFont','py4godot_fontvariation.FontVariation','py4godot_font.Font']:
    r''''''
  ...
  @functools.native_method
  def get_fallback_stylebox(self) -> typing.Union['py4godot_styleboxflat.StyleBoxFlat','py4godot_styleboxtexture.StyleBoxTexture','py4godot_styleboxline.StyleBoxLine','py4godot_stylebox.StyleBox','py4godot_styleboxempty.StyleBoxEmpty']:
    r''''''
