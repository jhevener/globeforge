...
class PhysicalBone2D(py4godot_rigidbody2d.RigidBody2D):
  ...
  def get_joint(self) -> typing.Union['py4godot_pinjoint2d.PinJoint2D','py4godot_dampedspringjoint2d.DampedSpringJoint2D','py4godot_joint2d.Joint2D','py4godot_groovejoint2d.GrooveJoint2D']:
    r'''
