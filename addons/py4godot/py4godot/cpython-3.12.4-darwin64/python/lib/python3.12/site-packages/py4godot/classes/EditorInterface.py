...
class EditorInterface(py4godot_object.Object):
  ...
  @functools.native_method
  def get_editor_main_screen(self) -> typing.Union['py4godot_vboxcontainer.VBoxContainer','py4godot_colorpicker.ColorPicker','py4godot_scripteditorbase.ScriptEditorBase']:
    r'''
