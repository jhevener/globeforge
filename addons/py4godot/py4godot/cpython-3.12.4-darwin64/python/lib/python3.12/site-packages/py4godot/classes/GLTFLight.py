...
class GLTFLight(py4godot_resource.Resource):
  ...
  def to_node(self) -> typing.Union['py4godot_spotlight3d.SpotLight3D','py4godot_omnilight3d.OmniLight3D','py4godot_directionallight3d.DirectionalLight3D','py4godot_light3d.Light3D']:
    r''''''
