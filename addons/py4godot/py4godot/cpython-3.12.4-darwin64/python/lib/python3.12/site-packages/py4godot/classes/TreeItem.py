...
class TreeItem(py4godot_object.Object):
  ...
  @functools.native_method
  def get_custom_stylebox(self, column:'int'   ) -> typing.Union['py4godot_styleboxflat.StyleBoxFlat','py4godot_styleboxtexture.StyleBoxTexture','py4godot_styleboxline.StyleBoxLine','py4godot_stylebox.StyleBox','py4godot_styleboxempty.StyleBoxEmpty']:
    r'''
  ...
  @functools.native_method
  def get_custom_font(self, column:'int'   ) -> typing.Union['py4godot_fontfile.FontFile','py4godot_systemfont.SystemFont','py4godot_fontvariation.FontVariation','py4godot_font.Font']:
    r'''
